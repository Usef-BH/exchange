...
function grab_latest(selectorTooltip) {
    ...
    fetch('http://exchange-env.gihqfqemv2.eu-west-3.elasticbeanstalk.com/api/latest')
        .then(resp => resp.json())
        .then(data => {
...
function grab_hist(selectorTooltip) {
    tooltipTextSend(selectorTooltip);
    fetch('http://exchange-env.gihqfqemv2.eu-west-3.elasticbeanstalk.com/api/2018-03-14')
        .then(resp => resp.json())
        .then(data => {
...
function grab_base(selectorTooltip) {
    tooltipTextSend(selectorTooltip);
    fetch('http://exchange-env.gihqfqemv2.eu-west-3.elasticbeanstalk.com/api/latest?base=USD&symbols=EUR,GBP,JPY')
        .then(resp => resp.json())
        .then(data => {
...
function grab_symbols(selectorTooltip) {
    tooltipTextSend(selectorTooltip);
    fetch('http://exchange-env.gihqfqemv2.eu-west-3.elasticbeanstalk.com/api/latest?symbols=USD,GBP')
        .then(resp => resp.json())
        .then(data => {
...
//http://django-env.grpimarsjd.eu-west-3.elasticbeanstalk.com
//http://django-env.grpimarsjd.eu-west-3.elasticbeanstalk.com
//http://django-env.grpimarsjd.eu-west-3.elasticbeanstalk.com
//http://django-env.grpimarsjd.eu-west-3.elasticbeanstalk.com
//http://django-env.grpimarsjd.eu-west-3.elasticbeanstalk.com